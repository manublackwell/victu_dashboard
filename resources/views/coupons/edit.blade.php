                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group row">
                                 ...
                                 <div class="col-md-9">
                                    <input type="number" id="quantita" class="form-control border-primary @error('quantity') is-invalid @enderror" placeholder="Quantità" name="quantity" value="{{ $coupon->qta }}">
                                 </div>
                                @error('quantity')
                                    <span class="danger float-right" role="alert">{{ $message }}</span>
                                @enderror
